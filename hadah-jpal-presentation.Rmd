...
---
layout: true
<div style="position: absolute;left:20px;bottom:5px;color:black;font-size: 12px;">Hussain Hadah (Tulane/Murphy Institute) | Parent’s Choice or School’s Choice?  | J-PAL `r format(Sys.time(), '%B %d %Y')`</div>
...
.right[.small[[[Summary Statistics]](#sum-tab)]]
...
.pull-left[
```{r example1, echo=FALSE, warning=FALSE, out.width="120%", fig.show='hold', fig.align='right'}
# Read the image file
img <- readPNG("assets/email-1.png")
...
.pull-right[
```{r example2, echo=FALSE, warning=FALSE, out.width="120%", fig.show='hold', fig.align='right'}
# Read the image file
img2 <- readPNG("assets/email-2.png")
...
##### Please let us know if you have any comments about the project

```{r qr-code, echo=FALSE, warning=FALSE, out.width="60%", fig.show='hold', fig.align='left'}
library(qrcode)

# Generate QR code SVG with transparent background
qr_code("https://forms.gle/r9vF1FcRGjhZ69gd8") |>
  generate_svg("assets/qrcode-slides.svg", background = "transparent", show = FALSE)

# Embed it
knitr::include_graphics("assets/qrcode-slides.svg")
...
## Summary Statistics from the NLSD .small[[[Back]](#data-sec)]
